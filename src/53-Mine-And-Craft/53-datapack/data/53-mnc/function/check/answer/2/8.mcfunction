...
execute unless score @s Option matches 3 run tellraw @s ["",{"text":"[53]","color":"gold","bold":true},{"text":"回答错误！","color":"red"},{"text":"正确答案是：","color":"green"},{"text":"C. 浮漂钩在物品实体上时收回会消耗4点耐久度","color":"aqua"}]
