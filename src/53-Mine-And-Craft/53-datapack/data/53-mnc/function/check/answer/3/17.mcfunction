...
execute unless score @s Option matches 1 run tellraw @s ["",{"text":"[53]","color":"gold","bold":true},{"text":"回答错误！","color":"red"},{"text":"正确答案是：","color":"green"},{"text":"A. 猫会受到摔落伤害","color":"aqua"}]
