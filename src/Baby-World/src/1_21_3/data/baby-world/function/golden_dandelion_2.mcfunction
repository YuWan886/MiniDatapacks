...
execute positioned ^ ^ ^0.1 if entity @e[type=#baby-world:animal,distance=..1,limit=1,sort= nearest,tag=!isbabylocked] run clear @s carrot_on_a_stick[custom_data={item:"golden_dandelion"}] 1
